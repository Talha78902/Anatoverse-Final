/**
 * AnatoVerse Human Body Explorer - Structured Anatomy Database
 * Contains detailed definitions for 11 body systems and 17 organs.
 */
  ...
  systems: [
    ...
    },
    {
      ...
      functions: [
        ...
        "Enables pregnancy, protective gestational growth, and nourishment of offspring."
      ],
      commonDisorders: [
        "Infertility",
        "Endometriosis",
  ...
  organs: [
    ...
    },
    {
      ...
      quickFacts: [
        ...
        "They secrete key renin hormones to regulate system-wide arterial body pressure."
      ],
    ...
    },
    {
      ...
      quickFacts: [
        ...
        "By weight, bones are made of about 30% organic materials and 70% tough calcium hydroxyapatite minerals."
      ],
    ...
    },
    {
      ...
      quickFacts: [
        ...
        "The strongest muscle in the human body relative to its size is the Masseter (chewing muscle) which can close teeth with 200 lbs of force.",
        "The Gluteus Maximus is the largest muscle in the human body, providing hip extension."
      ],
...
// Expose globally so index.html can access
